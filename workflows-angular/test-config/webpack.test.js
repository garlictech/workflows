...
const MY_TEST_RULES = require('../constants').myConstants.MY_TEST_RULES;
const MY_TEST_PLUGINS = require('../constants').myConstants.MY_TEST_PLUGINS;
...
if (!process.env.CI) {
    testConfig.plugins.push(new ProgressPlugin());
}
