...
const runOnce = ENV === 'unittest:once' || ENV === 'unittest:once:ci';
...
module.exports = function(config) {
    ...
    const configuration = {
        ...
        remapCoverageReporter: {
            'text-summary': null,
            json: '/app/artifacts/reports/coverage/coverage.json',
            html: '/app/artifacts/reports/coverage/html'
    ...
    if (process.env.TRAVIS) {
        configuration.browsers = ['ChromeCustom'];
