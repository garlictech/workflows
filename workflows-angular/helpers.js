...
function testDll() {
    if (!fs.existsSync('./artifacts/dll/polyfill.dll.js') || !fs.existsSync('./artifacts/dll/vendor.dll.js')) {
        throw "DLL files do not exist, please use 'npm run build:dll' once to generate dll files.";
    }
};

function webpackHook(path) {
    return "/app/hooks/webpack/" + path;
}
...
exports.webpackHook = webpackHook;