...
apt-get update
apt-get install -y --no-install-recommends zip python-pip python-dev build-essential apt-transport-https
...
apt-get remove --purge -y python-pip python-dev build-essential
