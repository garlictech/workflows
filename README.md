...
- They have no docker, npm, whatsoever parts. As minimum, only an `index.{ts,js}` and a package.json file are required.
...
- Jasmine will pull in all the files following the `\*.spec.{js,ts} pattern.
